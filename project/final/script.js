...
function changeText() {
  ...
  if (click == 1) {
    ...
    text.innerHTML = "<div><p>Well, I guess I have no other choice. If mom wants to drive me, I guess I have<br> to let her take me. It's better to not deal with people on the bus in the morning...</p></div>";
    window.setTimeout(fadein7, 1000);
  } else if (click == 7) {
    ...
    clothes.setAttribute('class', 'hide');
    window.setTimeout(fadein8, 1000);
  } else if (click == 8) {
    text.innerHTML = '<button id="btn3" name="btn">Pull out notebook and study</button>' + '<br><button id="btn4" name="btn">Look out the car window</button><br>(No images beyond this point)';
    ...
    text.innerHTML = "<div><p>I don't want to tell mom what's been bothering me lately. I don't want to <br>her about how I haven't been able to sleep because I'm nervous.</div></p>"
  }else if (click == 10) {
